...
const Countries = () => {
  ...
  useEffect(() => {
    const fetchCountries = async () => {
      ...
      // const arrayOfFilteredCountry = data.filter((e)=>console.log(e))
      setCountries(data);
  ...
  const handleDetailsOfCountry = (country) => {
    ...
    // countryCurrencies.map(({code,name,symbol})=>   console.log(code,name,symbol))
  ...
  return (
    <>
      ...
      {/* navber */}
      <Navber search={search} handleSearch={handleSearch} />
